...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "lessons" ALTER COLUMN "date" SET DEFAULT '2025-03-16T18:50:58.522Z';
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "pages_blocks_location" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "lessons" ALTER COLUMN "date" SET DEFAULT '2025-03-07T17:51:35.517Z';
