...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "lessons" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"date" timestamp(3) with time zone DEFAULT '2025-07-15T13:14:35.696Z' NOT NULL,
  ...
  CREATE TABLE "scheduler_schedule_monday_slots" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2025-07-15T13:14:35.850Z' NOT NULL,
  	"end_time" timestamp(3) with time zone DEFAULT '2025-07-15T13:14:35.850Z' NOT NULL,
  ...
  CREATE TABLE "scheduler" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"start_date" timestamp(3) with time zone DEFAULT '2025-07-15T13:14:35.850Z',
  	"end_date" timestamp(3) with time zone DEFAULT '2025-07-15T13:14:35.850Z',
