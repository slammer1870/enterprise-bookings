  ...
  return (
    ...
    >
      <div className="container row-span-1 mx-auto flex flex-col items-start justify-center px-4 pt-12 lg:row-span-2">
        ...
        <h3 className="text-xl text-[#FECE7E] md:text-2xl">{subheading}</h3>
      </div>
      <div className="row-span-1 flex h-auto w-full flex-col justify-center bg-[#BA4343] text-white lg:flex-row">
        <Link href={ctaLink}>
          <div className="bg-opacity-85 w-full cursor-pointer px-4 lg:py-16">
            <div className="container relative mx-auto h-full p-4">
              <h5 className="mb-2 text-xl uppercase md:text-2xl lg:mb-4">{ctaTitle}</h5>
              <p className="flex flex-col pb-8 md:text-lg">{ctaDescription}</p>
              <div className="absolute bottom-0 right-0 flex items-center p-4">
                <span className="text-sm font-medium uppercase lg:text-base">More Information</span>
                <svg
