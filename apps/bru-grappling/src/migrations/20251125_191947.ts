...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_url" varchar;
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_width" numeric;
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_height" numeric;
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_mime_type" varchar;
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_filesize" numeric;
  ALTER TABLE "media" ADD COLUMN IF NOT EXISTS "sizes_desktop_filename" varchar;
