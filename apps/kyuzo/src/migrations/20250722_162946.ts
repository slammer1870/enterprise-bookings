...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "scheduler_week_days_time_slot" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2025-07-22T16:29:46.318Z' NOT NULL,
  	"end_time" timestamp(3) with time zone DEFAULT '2025-07-22T16:29:46.318Z' NOT NULL,
  ...
  ALTER TABLE "timeslots" ALTER COLUMN "date" SET DEFAULT '2025-07-22T16:29:46.170Z';
