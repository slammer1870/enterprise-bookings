...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "timeslots" ALTER COLUMN "date" SET DEFAULT '2025-11-25T19:19:46.884Z';
  ...
  ALTER TABLE "timeslots" ADD COLUMN IF NOT EXISTS "active" boolean DEFAULT true;`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "timeslots" DROP COLUMN IF EXISTS "active";`)
}
