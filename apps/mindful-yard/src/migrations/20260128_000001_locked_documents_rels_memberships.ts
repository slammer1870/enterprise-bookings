 ...
 * Rename payload_locked_documents_rels.plans_id to memberships_id so Payload's locked-documents
 * queries match the current schema. If plans_id never existed (e.g. app added memberships later),
 * adds memberships_id instead.
 */
