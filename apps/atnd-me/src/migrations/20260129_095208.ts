...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN CREATE TYPE "public"."enum_memberships_sessions_information_interval" AS ENUM('day', 'week', 'month', 'quarter', 'year'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  DO $$ BEGIN CREATE TYPE "public"."enum_memberships_price_information_interval" AS ENUM('day', 'week', 'month', 'year'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  DO $$ BEGIN CREATE TYPE "public"."enum_memberships_status" AS ENUM('active', 'inactive'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  ...
  DO $$ BEGIN ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "memberships_id" integer; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
  ...
  DO $$ BEGIN ALTER TABLE "class_options_rels" ADD CONSTRAINT "class_options_rels_memberships_fk" FOREIGN KEY ("memberships_id") REFERENCES "public"."memberships"("id") ON DELETE cascade ON UPDATE no action; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  ...
  DO $$ BEGIN ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_plan_id_memberships_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."memberships"("id") ON DELETE set null ON UPDATE no action; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  DO $$ BEGIN ALTER TABLE "memberships_features" ADD CONSTRAINT "memberships_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."memberships"("id") ON DELETE cascade ON UPDATE no action; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  DO $$ BEGIN ALTER TABLE "memberships" ADD CONSTRAINT "memberships_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  ...
  CREATE INDEX IF NOT EXISTS "class_options_rels_memberships_id_idx" ON "class_options_rels" USING btree ("memberships_id");
  ...
  DO $$ BEGIN ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_memberships_fk" FOREIGN KEY ("memberships_id") REFERENCES "public"."memberships"("id") ON DELETE cascade ON UPDATE no action; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_memberships_sessions_information_interval";
  DROP TYPE "public"."enum_memberships_price_information_interval";
