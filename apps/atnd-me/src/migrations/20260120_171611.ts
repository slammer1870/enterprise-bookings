...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_schedule_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_hero_schedule_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_hero_schedule_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_schedule_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TABLE "pages_blocks_hero_schedule_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_hero_schedule_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_hero_schedule_links_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE "pages_blocks_hero_schedule" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_location" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Location',
  	"description" varchar,
  	"address" varchar,
  	"email" varchar,
  	"phone" varchar,
  ...
  CREATE TABLE "pages_blocks_three_column_layout" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_hero_schedule_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_hero_schedule_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_hero_schedule_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_hero_schedule" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_three_column_layout" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "footer" (
  	...
  	"styling_background_color" varchar,
  	"styling_text_color" varchar,
  	"styling_show_theme_selector" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "scheduler_week_days_time_slot" (
  	...
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2026-01-20T17:16:10.874Z' NOT NULL,
  ...
  ALTER TABLE "pages_blocks_hero_schedule_links" ADD CONSTRAINT "pages_blocks_hero_schedule_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_hero_schedule"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_schedule" ADD CONSTRAINT "pages_blocks_hero_schedule_background_image_id_media_id_fk" FOREIGN KEY ("background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_schedule" ADD CONSTRAINT "pages_blocks_hero_schedule_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_schedule" ADD CONSTRAINT "pages_blocks_hero_schedule_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_three_column_layout" ADD CONSTRAINT "pages_blocks_three_column_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hero_schedule_links" ADD CONSTRAINT "_pages_v_blocks_hero_schedule_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_hero_schedule"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_hero_schedule" ADD CONSTRAINT "_pages_v_blocks_hero_schedule_background_image_id_media_id_fk" FOREIGN KEY ("background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_hero_schedule" ADD CONSTRAINT "_pages_v_blocks_hero_schedule_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_hero_schedule" ADD CONSTRAINT "_pages_v_blocks_hero_schedule_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_three_column_layout" ADD CONSTRAINT "_pages_v_blocks_three_column_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_schedule_links_order_idx" ON "pages_blocks_hero_schedule_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_schedule_links_parent_id_idx" ON "pages_blocks_hero_schedule_links" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_hero_schedule_order_idx" ON "pages_blocks_hero_schedule" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_schedule_parent_id_idx" ON "pages_blocks_hero_schedule" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_hero_schedule_path_idx" ON "pages_blocks_hero_schedule" USING btree ("_path");
  CREATE INDEX "pages_blocks_hero_schedule_background_image_idx" ON "pages_blocks_hero_schedule" USING btree ("background_image_id");
  CREATE INDEX "pages_blocks_hero_schedule_logo_idx" ON "pages_blocks_hero_schedule" USING btree ("logo_id");
  ...
  CREATE INDEX "pages_blocks_three_column_layout_order_idx" ON "pages_blocks_three_column_layout" USING btree ("_order");
  CREATE INDEX "pages_blocks_three_column_layout_parent_id_idx" ON "pages_blocks_three_column_layout" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_three_column_layout_path_idx" ON "pages_blocks_three_column_layout" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_hero_schedule_links_order_idx" ON "_pages_v_blocks_hero_schedule_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_hero_schedule_links_parent_id_idx" ON "_pages_v_blocks_hero_schedule_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_hero_schedule_order_idx" ON "_pages_v_blocks_hero_schedule" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_hero_schedule_parent_id_idx" ON "_pages_v_blocks_hero_schedule" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_hero_schedule_path_idx" ON "_pages_v_blocks_hero_schedule" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_hero_schedule_background_image_idx" ON "_pages_v_blocks_hero_schedule" USING btree ("background_image_id");
  CREATE INDEX "_pages_v_blocks_hero_schedule_logo_idx" ON "_pages_v_blocks_hero_schedule" USING btree ("logo_id");
  ...
  CREATE INDEX "_pages_v_blocks_three_column_layout_order_idx" ON "_pages_v_blocks_three_column_layout" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_three_column_layout_parent_id_idx" ON "_pages_v_blocks_three_column_layout" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_three_column_layout_path_idx" ON "_pages_v_blocks_three_column_layout" USING btree ("_path");
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_hero_schedule_links" CASCADE;
  DROP TABLE "pages_blocks_hero_schedule" CASCADE;
  ...
  DROP TABLE "pages_blocks_three_column_layout" CASCADE;
  DROP TABLE "pages" CASCADE;
  DROP TABLE "pages_rels" CASCADE;
  DROP TABLE "_pages_v_version_hero_links" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_schedule_links" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_schedule" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_three_column_layout" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_hero_schedule_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_hero_schedule_links_link_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_hero_schedule_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_hero_schedule_links_link_appearance";
  ...
  DROP TYPE "public"."enum_header_nav_items_button_variant";
  DROP TYPE "public"."enum_header_styling_padding";
