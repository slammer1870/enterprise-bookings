...
export const createLesson = async (
  ...
  return payload.create({
    ...
    data: {
      ...
      endTime: lessonData.endTime.toISOString(),
      classOption: typeof lessonData.classOption === 'string' ? parseInt(lessonData.classOption, 10) : lessonData.classOption,
      location: lessonData.location,
      lockOutTime: lessonData.lockOutTime,
      instructor: typeof lessonData.instructor === 'string' ? parseInt(lessonData.instructor, 10) : lessonData.instructor,
    },
  });
};
