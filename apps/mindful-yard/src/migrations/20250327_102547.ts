...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "scheduler_schedule_monday_slots" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2025-03-27T10:25:46.330Z' NOT NULL,
  	"end_time" timestamp(3) with time zone DEFAULT '2025-03-27T10:25:46.330Z' NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "scheduler" (
  	...
  	"start_date" timestamp(3) with time zone DEFAULT '2025-03-27T10:25:46.329Z',
  	"end_date" timestamp(3) with time zone DEFAULT '2025-03-27T10:25:46.329Z',
  ...
  ALTER TABLE "lessons" ALTER COLUMN "date" SET DEFAULT '2025-03-27T10:25:45.033Z';
  DO $$ BEGIN
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "lessons" ALTER COLUMN "date" SET DEFAULT '2025-03-25T14:21:19.371Z';`)
}
