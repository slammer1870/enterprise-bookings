 ...
 *
 * Some Better Auth plugin collections (e.g. `sessions`, `accounts`) can require `updatedAt`/`createdAt`
 ...
 *   - "The following field is invalid: General:updatedAt" (collection: accounts, path: updatedAt)
 *
