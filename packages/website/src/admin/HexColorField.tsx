...
export const HexColorField: React.FC<HexColorFieldProps> = ({
  ...
  const resolvedHex = resolveColorToken(storedValue)
  ...
  const applyColor = (next: string | null) => {
    ...
    setValue(next)
    if (next) {
      const hex = resolveColorToken(next)
  ...
  const triggerLabel = displayHex ?? 'Theme default'

  return (
    <div className="field-type text hex-color-field" ref={rootRef} style={{ position: 'relative' }}>
      ...
      {open ? (
        <div
          ...
          className="hex-color-field__dialog"
        >
          ...
          <div className="hex-color-field__controls">
            <input
              ...
              spellCheck={false}
              className="hex-color-field__hex-input"
            />
            ...
            {canUseEyeDropper ? (
              <button
                ...
                className="hex-color-field__eyedropper"
              >
                <EyedropperIcon />
              </button>
            ) : null}
          ...
          <div className="hex-color-field__presets">
            {COLOR_PRESETS.map((option) => (
              <button
                ...
                className="hex-color-field__preset"
          ...
          <button
            ...
            className="hex-color-field__default"
          >
            Use theme default
          </button>
        </div>
