...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "scheduler_week_days_time_slot" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2025-07-22T16:31:11.600Z' NOT NULL,
  	"end_time" timestamp(3) with time zone DEFAULT '2025-07-22T16:31:11.600Z' NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TABLE "scheduler_schedule_monday_slots" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"start_time" timestamp(3) with time zone DEFAULT '2025-07-21T20:48:03.740Z' NOT NULL,
  	"end_time" timestamp(3) with time zone DEFAULT '2025-07-21T20:48:03.740Z' NOT NULL,
  	"class_option_id" integer,
  	"location" varchar,
  	"instructor_id" integer,
  	"lock_out_time" numeric,
